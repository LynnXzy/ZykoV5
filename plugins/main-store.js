...
`
  /*  {title: "🔖 HEMAT", rowId: '.order *Paket:* HEMAT • Sewa', description: 'PRICE: Rm' + sh + ' (1 minggu)' },
	    {title: "🔖 NORMAL", rowId: '.order *Paket:* NORMAL • Sewa', description: Rm'PRICE: ' + sn + ' (1 bulan)' },
	{title: "🔖 STANDAR", rowId: '.order *Paket:* STANDAR • Sewa', description: Rm'PRICE: ' + ss + ' (2 bulan)' },
...
description: 'Pʀɪᴄᴇ Sᴇᴡᴀ Rm 5 : 7 Hᴀʀɪ' },
{title: "⟣⟨ NORMAL ⟩⟢",
rowId: '.store sewabottt 15 Hari',
description: 'Pʀɪᴄᴇ Sᴇᴡᴀ Rm 10 : 15 Hᴀʀɪ' },
{title: "⟣⟨ STANDAR ⟩⟢",
rowId: '.store sewabottt 30 hari',
description: 'Pʀɪᴄᴇ Sᴇᴡᴀ Rm 20 : 30 Hᴀʀɪ' },
{title: "⟣⟨ PRO ⟩⟢",
rowId: '.store sewabottt 40 hari',
description: 'Pʀɪᴄᴇ Sᴇᴡᴀ Rm 25 : 40 Hᴀʀɪ' },
]},
{
